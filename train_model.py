...
from pycaret.classification import create_model, compare_models, finalize_model, save_model
...
def generate_synthetic_data(n_each: int = 2000, include_benign: bool = True) -> pd.DataFrame:
    ...
    def bern(p, size): return rng.binomial(1, p, size)
...
def train_classifier(df: pd.DataFrame, out_dir: str = "models") -> str:
    ...
    features = [
        ...
        "URL_Length","abnormal_URL_Structure","num_subdomains","has_political_keyword",
    ]
    cls_setup(
